...
В реализацията (Task 3) интерфейсът включва още: настройка на ComfyUI URL и бутон „Test connection“ за проверка на връзката; падащо меню за избор на checkpoint, заредено от списъка на ComfyUI; в режим dev при подразбирания URL приложението използва Vite proxy и не изисква CORS от ComfyUI.
